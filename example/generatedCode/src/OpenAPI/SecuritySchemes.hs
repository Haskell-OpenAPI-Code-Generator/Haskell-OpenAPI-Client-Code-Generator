...
--   }
-- @
data BasicAuthenticationSecurityScheme = BasicAuthenticationSecurityScheme
...
instance OpenAPI.Common.SecurityScheme BasicAuthenticationSecurityScheme where
  authenticateRequest basicAuth = Network.HTTP.Client.Request.applyBasicAuth (OpenAPI.Common.textToByte GHC.Base.$ basicAuthenticationSecuritySchemeUsername basicAuth) (OpenAPI.Common.textToByte GHC.Base.$ basicAuthenticationSecuritySchemePassword basicAuth)
...
instance OpenAPI.Common.SecurityScheme BearerAuthenticationSecurityScheme where
  authenticateRequest (BearerAuthenticationSecurityScheme token) = Network.HTTP.Simple.addRequestHeader "Authorization" GHC.Base.$ (OpenAPI.Common.textToByte GHC.Base.$ ("Bearer " GHC.Base.<> token))
