...
instance Data.Aeson.ToJSON Order
    where toJSON obj = Data.Aeson.object ((Data.Aeson..=) "complete" (orderComplete obj) : (Data.Aeson..=) "id" (orderId obj) : (Data.Aeson..=) "petId" (orderPetId obj) : (Data.Aeson..=) "quantity" (orderQuantity obj) : (Data.Aeson..=) "shipDate" (orderShipDate obj) : (Data.Aeson..=) "status" (orderStatus obj) : [])
...
instance Data.Aeson.ToJSON OrderStatus
    where toJSON (OrderStatusEnumOther patternName) = Data.Aeson.Types.ToJSON.toJSON patternName
...
instance Data.Aeson.FromJSON OrderStatus
    where parseJSON val = GHC.Base.pure (if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "approved")
                                          then OrderStatusEnumString_approved
                                                ...
                                                else if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "placed")
