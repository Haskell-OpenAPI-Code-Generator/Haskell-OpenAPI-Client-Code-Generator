...
instance Data.Aeson.ToJSON Pet where
  toJSON obj = Data.Aeson.object ((Data.Aeson..=) "category" (petCategory obj) : (Data.Aeson..=) "id" (petId obj) : (Data.Aeson..=) "name" (petName obj) : (Data.Aeson..=) "photoUrls" (petPhotoUrls obj) : (Data.Aeson..=) "status" (petStatus obj) : (Data.Aeson..=) "tags" (petTags obj) : [])
...
instance Data.Aeson.Types.FromJSON.FromJSON Pet where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Pet" (\obj -> (((((GHC.Base.pure Pet GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "category")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "photoUrls")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "tags"))
...
instance Data.Aeson.ToJSON PetStatus where
  toJSON (PetStatusEnumOther patternName) = Data.Aeson.Types.ToJSON.toJSON patternName
...
instance Data.Aeson.FromJSON PetStatus where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "available")
          then PetStatusEnumString_available
            ...
            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "pending")
              then PetStatusEnumString_pending
                ...
                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "sold")
