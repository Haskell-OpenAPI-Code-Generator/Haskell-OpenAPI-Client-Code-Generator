...
instance Data.Aeson.Types.ToJSON.ToJSON Tag
    where toJSON obj = Data.Aeson.Types.Internal.object ("id" Data.Aeson.Types.ToJSON..= tagId obj : "name" Data.Aeson.Types.ToJSON..= tagName obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("id" Data.Aeson.Types.ToJSON..= tagId obj) GHC.Base.<> ("name" Data.Aeson.Types.ToJSON..= tagName obj))
