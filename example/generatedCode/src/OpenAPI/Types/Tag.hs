...
instance Data.Aeson.ToJSON Tag where
  toJSON obj = Data.Aeson.object ((Data.Aeson..=) "id" (tagId obj) : (Data.Aeson..=) "name" (tagName obj) : [])
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "id" (tagId obj) GHC.Base.<> (Data.Aeson..=) "name" (tagName obj))

instance Data.Aeson.Types.FromJSON.FromJSON Tag where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Tag" (\obj -> (GHC.Base.pure Tag GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "name"))
