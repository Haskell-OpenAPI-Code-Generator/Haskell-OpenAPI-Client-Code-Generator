...
-- 
-- 
updatePetWithForm :: forall m s . (OpenAPI.Common.MonadHTTP m, OpenAPI.Common.SecurityScheme s) => OpenAPI.Common.Configuration s  -- ^ The configuration to use in the request
  -> GHC.Int.Int64                                                                                                                 -- ^ petId: ID of pet that needs to be updated
  -> UpdatePetWithFormRequestBody                                                                                                  -- ^ The request body to send
  -> m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response UpdatePetWithFormResponse)) -- ^ Monad containing the result of the operation
updatePetWithForm config
                  petId
                  body = GHC.Base.fmap (GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either UpdatePetWithFormResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 405) (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right UpdatePetWithFormResponse405
                                                                                                                                                                                    | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0)) (OpenAPI.Common.doBodyCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack ("/pet/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ OpenAPI.Common.stringifyModel petId)) GHC.Base.++ ""))) [] body OpenAPI.Common.RequestBodyEncodingFormData)
-- | > POST /pet/{petId}
-- 
-- The same as 'updatePetWithForm' but returns the raw 'Data.ByteString.Char8.ByteString'
updatePetWithFormRaw :: forall m s . (OpenAPI.Common.MonadHTTP m,
...
updatePetWithFormM :: forall m s . (OpenAPI.Common.MonadHTTP m,
                                    OpenAPI.Common.SecurityScheme s) =>
                      GHC.Int.Int64 ->
                      UpdatePetWithFormRequestBody ->
...
updatePetWithFormM petId
                   body = GHC.Base.fmap (GHC.Base.fmap (\response_2 -> GHC.Base.fmap (Data.Either.either UpdatePetWithFormResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_3 -> Network.HTTP.Types.Status.statusCode status_3 GHC.Classes.== 405) (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right UpdatePetWithFormResponse405
                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_2) response_2)) (OpenAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack ("/pet/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ OpenAPI.Common.stringifyModel petId)) GHC.Base.++ ""))) [] body OpenAPI.Common.RequestBodyEncodingFormData)
-- | > POST /pet/{petId}
-- 
-- Monadic version of 'updatePetWithFormRaw' (use with 'OpenAPI.Common.runWithConfiguration')
updatePetWithFormRawM :: forall m s . (OpenAPI.Common.MonadHTTP m,
                                       OpenAPI.Common.SecurityScheme s) =>
                         GHC.Int.Int64 ->
                         UpdatePetWithFormRequestBody ->
                         Control.Monad.Trans.Reader.ReaderT (OpenAPI.Common.Configuration s)
...
data UpdatePetWithFormRequestBody = UpdatePetWithFormRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.ToJSON UpdatePetWithFormRequestBody
    where toJSON obj = Data.Aeson.object ((Data.Aeson..=) "name" (updatePetWithFormRequestBodyName obj) : (Data.Aeson..=) "status" (updatePetWithFormRequestBodyStatus obj) : [])
