...
createUsersWithListInput ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response CreateUsersWithListInputResponse))
createUsersWithListInput
  config
  body =
    GHC.Base.fmap
      ( GHC.Base.fmap
          ( \response_0 ->
              GHC.Base.fmap
                ( Data.Either.either CreateUsersWithListInputResponseError GHC.Base.id
                    GHC.Base.. ( \response body ->
                                   if
                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right CreateUsersWithListInputResponseDefault
      ...
      (OpenAPI.Common.doBodyCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack "/user/createWithList") [] body OpenAPI.Common.RequestBodyEncodingJSON)
...
createUsersWithListInputM body =
  GHC.Base.fmap
    ( GHC.Base.fmap
        ( \response_1 ->
            GHC.Base.fmap
    ...
    (OpenAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack "/user/createWithList") [] body OpenAPI.Common.RequestBodyEncodingJSON)

-- | > POST /user/createWithList
--
-- Monadic version of 'createUsersWithListInputRaw' (use with 'OpenAPI.Common.runWithConfiguration')
createUsersWithListInputRawM ::
  forall m s.
  ( OpenAPI.Common.MonadHTTP m,
    OpenAPI.Common.SecurityScheme s
  ) =>
...
data CreateUsersWithListInputResponse
  = -- | Means either no matching case available or a parse error
    CreateUsersWithListInputResponseError GHC.Base.String
