...
createUsersWithListInput body = GHC.Internal.Base.fmap (\response_0 -> GHC.Internal.Base.fmap (GHC.Internal.Data.Either.either CreateUsersWithListInputResponseError GHC.Internal.Base.id GHC.Internal.Base.. (\response body -> if | GHC.Internal.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GHC.Internal.Data.Either.Right CreateUsersWithListInputResponseDefault
...
data CreateUsersWithListInputResponse =
   CreateUsersWithListInputResponseError GHC.Internal.Base.String -- ^ Means either no matching case available or a parse error
...
createUsersWithListInputWithConfiguration config
                                          body = GHC.Internal.Base.fmap (\response_1 -> GHC.Internal.Base.fmap (GHC.Internal.Data.Either.either CreateUsersWithListInputResponseError GHC.Internal.Base.id GHC.Internal.Base.. (\response body -> if | GHC.Internal.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GHC.Internal.Data.Either.Right CreateUsersWithListInputResponseDefault
...
createUsersWithListInputRaw body = GHC.Internal.Base.id (OpenAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Internal.Base.$ Data.Text.Internal.pack "POST") "/user/createWithList" GHC.Internal.Base.mempty (GHC.Internal.Maybe.Just body) OpenAPI.Common.RequestBodyEncodingJSON)
-- | > POST /user/createWithList
-- 
...
createUsersWithListInputWithConfigurationRaw config
                                             body = GHC.Internal.Base.id (OpenAPI.Common.doBodyCallWithConfiguration config (Data.Text.toUpper GHC.Internal.Base.$ Data.Text.Internal.pack "POST") "/user/createWithList" GHC.Internal.Base.mempty (GHC.Internal.Maybe.Just body) OpenAPI.Common.RequestBodyEncodingJSON)
