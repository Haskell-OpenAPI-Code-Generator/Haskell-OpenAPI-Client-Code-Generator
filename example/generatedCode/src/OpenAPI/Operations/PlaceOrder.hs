...
placeOrder ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PlaceOrderResponse))
placeOrder
  config
  body =
    GHC.Base.fmap
      ( GHC.Base.fmap
          ( \response_0 ->
              GHC.Base.fmap
                ( Data.Either.either PlaceOrderResponseError GHC.Base.id
      ...
      (OpenAPI.Common.doBodyCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack "/store/order") [] body OpenAPI.Common.RequestBodyEncodingJSON)
...
placeOrderM body =
  GHC.Base.fmap
    ...
    (OpenAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack "/store/order") [] body OpenAPI.Common.RequestBodyEncodingJSON)
...
data PlaceOrderResponse
  = -- | Means either no matching case available or a parse error
    PlaceOrderResponseError GHC.Base.String
  | -- | successful operation
    PlaceOrderResponse200 Order
  | -- | Invalid Order
