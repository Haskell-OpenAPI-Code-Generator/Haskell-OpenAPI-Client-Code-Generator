...
findPetsByTags :: forall m s . (OpenAPI.Common.MonadHTTP m, OpenAPI.Common.SecurityScheme s) => OpenAPI.Common.Configuration s  -- ^ The configuration to use in the request
  -> GHC.Base.String                                                                                                            -- ^ tags: Tags to filter by
  -> m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response FindPetsByTagsResponse)) -- ^ Monad containing the result of the operation
findPetsByTags config
               tags = GHC.Base.fmap (GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either FindPetsByTagsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> FindPetsByTagsResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                            ([] Pet))
                                                                                                                                                                              ...
                                                                                                                                                                              | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0)) (OpenAPI.Common.doCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "GET")) (Data.Text.pack "/pet/findByTags") ((Data.Text.pack "tags",
...
findPetsByTagsRaw :: forall m s . (OpenAPI.Common.MonadHTTP m,
                                   OpenAPI.Common.SecurityScheme s) =>
                     OpenAPI.Common.Configuration s ->
                     GHC.Base.String ->
                     m (Data.Either.Either Network.HTTP.Client.Types.HttpException
                                           (Network.HTTP.Client.Types.Response Data.ByteString.Internal.ByteString))
findPetsByTagsRaw config
                  tags = GHC.Base.id (OpenAPI.Common.doCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "GET")) (Data.Text.pack "/pet/findByTags") ((Data.Text.pack "tags",
                                                                                                                                                                    GHC.Base.Just GHC.Base.$ OpenAPI.Common.stringifyModel tags) : []))
-- | > GET /pet/findByTags
-- 
-- Monadic version of 'findPetsByTags' (use with 'OpenAPI.Common.runWithConfiguration')
findPetsByTagsM :: forall m s . (OpenAPI.Common.MonadHTTP m,
                                 OpenAPI.Common.SecurityScheme s) =>
                   GHC.Base.String ->
...
findPetsByTagsM tags = GHC.Base.fmap (GHC.Base.fmap (\response_3 -> GHC.Base.fmap (Data.Either.either FindPetsByTagsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_4 -> Network.HTTP.Types.Status.statusCode status_4 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> FindPetsByTagsResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                               ...
                                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_3) response_3)) (OpenAPI.Common.doCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "GET")) (Data.Text.pack "/pet/findByTags") ((Data.Text.pack "tags",
                                                                                                                                                                                                                                                                                                                                                                                                           GHC.Base.Just GHC.Base.$ OpenAPI.Common.stringifyModel tags) : []))
-- | > GET /pet/findByTags
-- 
-- Monadic version of 'findPetsByTagsRaw' (use with 'OpenAPI.Common.runWithConfiguration')
findPetsByTagsRawM :: forall m s . (OpenAPI.Common.MonadHTTP m,
                                    OpenAPI.Common.SecurityScheme s) =>
                      GHC.Base.String ->
                      Control.Monad.Trans.Reader.ReaderT (OpenAPI.Common.Configuration s)
                                                         m
                                                         (Data.Either.Either Network.HTTP.Client.Types.HttpException
                                                                             (Network.HTTP.Client.Types.Response Data.ByteString.Internal.ByteString))
findPetsByTagsRawM tags = GHC.Base.id (OpenAPI.Common.doCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "GET")) (Data.Text.pack "/pet/findByTags") ((Data.Text.pack "tags",
                                                                                                                                                               GHC.Base.Just GHC.Base.$ OpenAPI.Common.stringifyModel tags) : []))
