...
createUser :: forall m s . (OpenAPI.Common.MonadHTTP m, OpenAPI.Common.SecurityScheme s) => OpenAPI.Common.Configuration s  -- ^ The configuration to use in the request
...
createUser config
           body = GHC.Base.fmap (GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either CreateUserResponseError GHC.Base.id GHC.Base.. (\response body -> if | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right CreateUserResponseDefault
                                                                                                                                                                      | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0)) (OpenAPI.Common.doBodyCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack "/user") [] body OpenAPI.Common.RequestBodyEncodingJSON)
-- | > POST /user
-- 
-- The same as 'createUser' but returns the raw 'Data.ByteString.Char8.ByteString'
createUserRaw :: forall m s . (OpenAPI.Common.MonadHTTP m,
...
createUserM :: forall m s . (OpenAPI.Common.MonadHTTP m,
                             OpenAPI.Common.SecurityScheme s) =>
               User ->
...
createUserM body = GHC.Base.fmap (GHC.Base.fmap (\response_1 -> GHC.Base.fmap (Data.Either.either CreateUserResponseError GHC.Base.id GHC.Base.. (\response body -> if | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right CreateUserResponseDefault
                                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_1) response_1)) (OpenAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack "/user") [] body OpenAPI.Common.RequestBodyEncodingJSON)
-- | > POST /user
-- 
-- Monadic version of 'createUserRaw' (use with 'OpenAPI.Common.runWithConfiguration')
createUserRawM :: forall m s . (OpenAPI.Common.MonadHTTP m,
                                OpenAPI.Common.SecurityScheme s) =>
                  User ->
                  Control.Monad.Trans.Reader.ReaderT (OpenAPI.Common.Configuration s)
                                                     m
...
data CreateUserResponse =                   
  ...
  | CreateUserResponseDefault               -- ^ successful operation
