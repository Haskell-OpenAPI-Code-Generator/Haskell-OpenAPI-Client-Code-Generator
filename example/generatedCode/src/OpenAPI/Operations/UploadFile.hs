...
-- 
-- 
uploadFile :: forall m . OpenAPI.Common.MonadHTTP m => GHC.Internal.Int.Int64 -- ^ petId: ID of pet to update
...
uploadFile petId = GHC.Internal.Base.fmap (\response_0 -> GHC.Internal.Base.fmap (GHC.Internal.Data.Either.either UploadFileResponseError GHC.Internal.Base.id GHC.Internal.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> UploadFileResponse200 GHC.Internal.Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: GHC.Internal.Data.Either.Either GHC.Internal.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ApiResponse)
                                                                                                                                                                                                         | GHC.Internal.Base.otherwise -> GHC.Internal.Data.Either.Left "Missing default response type") response_0) response_0) (OpenAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Internal.Base.$ Data.Text.Internal.pack "POST") ("/pet/" GHC.Internal.Base.<> (OpenAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Internal.Base.$ (OpenAPI.Common.textToByte GHC.Internal.Base.$ OpenAPI.Common.stringifyModel petId)) GHC.Internal.Base.<> "/uploadImage")) GHC.Internal.Base.mempty)
...
data UploadFileResponse =
   UploadFileResponseError GHC.Internal.Base.String -- ^ Means either no matching case available or a parse error
...
uploadFileWithConfiguration :: forall m . OpenAPI.Common.MonadHTTP m => OpenAPI.Common.Configuration -- ^ The configuration to use in the request
  -> GHC.Internal.Int.Int64 -- ^ petId: ID of pet to update
...
uploadFileWithConfiguration config
                            petId = GHC.Internal.Base.fmap (\response_2 -> GHC.Internal.Base.fmap (GHC.Internal.Data.Either.either UploadFileResponseError GHC.Internal.Base.id GHC.Internal.Base.. (\response body -> if | (\status_3 -> Network.HTTP.Types.Status.statusCode status_3 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> UploadFileResponse200 GHC.Internal.Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: GHC.Internal.Data.Either.Either GHC.Internal.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ApiResponse)
...
uploadFileRaw :: forall m . OpenAPI.Common.MonadHTTP m => GHC.Internal.Int.Int64 -- ^ petId: ID of pet to update
...
uploadFileRaw petId = GHC.Internal.Base.id (OpenAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Internal.Base.$ Data.Text.Internal.pack "POST") ("/pet/" GHC.Internal.Base.<> (OpenAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Internal.Base.$ (OpenAPI.Common.textToByte GHC.Internal.Base.$ OpenAPI.Common.stringifyModel petId)) GHC.Internal.Base.<> "/uploadImage")) GHC.Internal.Base.mempty)
-- | > POST /pet/{petId}/uploadImage
-- 
...
uploadFileWithConfigurationRaw config
                               petId = GHC.Internal.Base.id (OpenAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Internal.Base.$ Data.Text.Internal.pack "POST") ("/pet/" GHC.Internal.Base.<> (OpenAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Internal.Base.$ (OpenAPI.Common.textToByte GHC.Internal.Base.$ OpenAPI.Common.stringifyModel petId)) GHC.Internal.Base.<> "/uploadImage")) GHC.Internal.Base.mempty)
