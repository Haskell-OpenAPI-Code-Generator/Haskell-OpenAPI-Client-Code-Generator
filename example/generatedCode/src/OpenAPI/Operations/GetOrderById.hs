...
getOrderById ::
  ...
  -- | orderId: ID of pet that needs to be fetched | Constraints: Maxium  of 10.0, Minimum  of 1.0
  GHC.Int.Int64 ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetOrderByIdResponse))
getOrderById
  config
  orderId =
    GHC.Base.fmap
      ( GHC.Base.fmap
          ( \response_0 ->
              GHC.Base.fmap
                ( Data.Either.either GetOrderByIdResponseError GHC.Base.id
      ...
      (OpenAPI.Common.doCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "GET")) (Data.Text.pack ("/store/order/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ OpenAPI.Common.stringifyModel orderId)) GHC.Base.++ ""))) [])
...
getOrderByIdM orderId =
  GHC.Base.fmap
    ...
    (OpenAPI.Common.doCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "GET")) (Data.Text.pack ("/store/order/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ OpenAPI.Common.stringifyModel orderId)) GHC.Base.++ ""))) [])
...
data GetOrderByIdResponse
  = -- | Means either no matching case available or a parse error
    GetOrderByIdResponseError GHC.Base.String
  | -- | successful operation
    GetOrderByIdResponse200 Order
  | -- | Invalid ID supplied
