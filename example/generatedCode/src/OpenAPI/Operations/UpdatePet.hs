...
-- 
-- 
updatePet :: forall m s . (OpenAPI.Common.MonadHTTP m, OpenAPI.Common.SecurityScheme s) => OpenAPI.Common.Configuration s  -- ^ The configuration to use in the request
  -> Pet                                                                                                                   -- ^ The request body to send
  -> m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response UpdatePetResponse)) -- ^ Monad containing the result of the operation
updatePet config
          body = GHC.Base.fmap (GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either UpdatePetResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 400) (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right UpdatePetResponse400
                                                                                                                                                                    ...
                                                                                                                                                                    | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0)) (OpenAPI.Common.doBodyCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "PUT")) (Data.Text.pack "/pet") [] body OpenAPI.Common.RequestBodyEncodingJSON)
-- | > PUT /pet
-- 
-- The same as 'updatePet' but returns the raw 'Data.ByteString.Char8.ByteString'
updatePetRaw :: forall m s . (OpenAPI.Common.MonadHTTP m,
...
updatePetM :: forall m s . (OpenAPI.Common.MonadHTTP m,
                            OpenAPI.Common.SecurityScheme s) =>
              Pet ->
...
updatePetM body = GHC.Base.fmap (GHC.Base.fmap (\response_4 -> GHC.Base.fmap (Data.Either.either UpdatePetResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_5 -> Network.HTTP.Types.Status.statusCode status_5 GHC.Classes.== 400) (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right UpdatePetResponse400
                                                                                                                                                                     ...
                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_4) response_4)) (OpenAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "PUT")) (Data.Text.pack "/pet") [] body OpenAPI.Common.RequestBodyEncodingJSON)
-- | > PUT /pet
-- 
-- Monadic version of 'updatePetRaw' (use with 'OpenAPI.Common.runWithConfiguration')
updatePetRawM :: forall m s . (OpenAPI.Common.MonadHTTP m,
                               OpenAPI.Common.SecurityScheme s) =>
                 Pet ->
                 Control.Monad.Trans.Reader.ReaderT (OpenAPI.Common.Configuration s)
                                                    m
