...
addPet ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response AddPetResponse))
addPet
  config
  body =
    GHC.Base.fmap
      ( GHC.Base.fmap
          ( \response_0 ->
              GHC.Base.fmap
                ( Data.Either.either AddPetResponseError GHC.Base.id
                    GHC.Base.. ( \response body ->
                                   if
                                       | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right AddPetResponse200
      ...
      (OpenAPI.Common.doBodyCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack "/pet") [] body OpenAPI.Common.RequestBodyEncodingJSON)
...
addPetM body =
  GHC.Base.fmap
        ...
        ( \response_3 ->
            GHC.Base.fmap
              ( Data.Either.either AddPetResponseError GHC.Base.id
                  GHC.Base.. ( \response body ->
                                 if
                                     | (\status_4 -> Network.HTTP.Types.Status.statusCode status_4 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right AddPetResponse200
    ...
    (OpenAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "POST")) (Data.Text.pack "/pet") [] body OpenAPI.Common.RequestBodyEncodingJSON)
...
data AddPetResponse
  = -- | Means either no matching case available or a parse error
    AddPetResponseError GHC.Base.String
  | -- | Success
    AddPetResponse200
  | -- | Invalid input
    AddPetResponse405
