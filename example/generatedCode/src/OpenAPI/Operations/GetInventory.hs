...
getInventory ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetInventoryResponse))
getInventory config =
  GHC.Base.fmap
    ( GHC.Base.fmap
        ( \response_0 ->
            GHC.Base.fmap
              ( Data.Either.either GetInventoryResponseError GHC.Base.id
    ...
    (OpenAPI.Common.doCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "GET")) (Data.Text.pack "/store/inventory") [])
...
getInventoryM =
  GHC.Base.fmap
    ...
    (OpenAPI.Common.doCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "GET")) (Data.Text.pack "/store/inventory") [])
...
data GetInventoryResponse
  = -- | Means either no matching case available or a parse error
    GetInventoryResponseError GHC.Base.String
  | -- | successful operation
    GetInventoryResponse200 GetInventoryResponseBody200
...
instance Data.Aeson.ToJSON GetInventoryResponseBody200 where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetInventoryResponseBody200 where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetInventoryResponseBody200" (\obj -> GHC.Base.pure GetInventoryResponseBody200)
