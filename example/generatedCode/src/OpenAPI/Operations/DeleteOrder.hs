...
deleteOrder ::
  ...
  -- | orderId: ID of the order that needs to be deleted | Constraints: Minimum  of 1.0
  GHC.Int.Int64 ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response DeleteOrderResponse))
deleteOrder
  config
  orderId =
    GHC.Base.fmap
      ( GHC.Base.fmap
          ( \response_0 ->
              GHC.Base.fmap
                ( Data.Either.either DeleteOrderResponseError GHC.Base.id
                    GHC.Base.. ( \response body ->
                                   if
                                       | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 400) (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right DeleteOrderResponse400
      ...
      (OpenAPI.Common.doCallWithConfiguration config (Data.Text.toUpper (Data.Text.pack "DELETE")) (Data.Text.pack ("/store/order/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ OpenAPI.Common.stringifyModel orderId)) GHC.Base.++ ""))) [])
...
deleteOrderM orderId =
  GHC.Base.fmap
        ...
        ( \response_3 ->
            GHC.Base.fmap
              ( Data.Either.either DeleteOrderResponseError GHC.Base.id
                  GHC.Base.. ( \response body ->
                                 if
                                     | (\status_4 -> Network.HTTP.Types.Status.statusCode status_4 GHC.Classes.== 400) (Network.HTTP.Client.Types.responseStatus response) -> Data.Either.Right DeleteOrderResponse400
    ...
    (OpenAPI.Common.doCallWithConfigurationM (Data.Text.toUpper (Data.Text.pack "DELETE")) (Data.Text.pack ("/store/order/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ OpenAPI.Common.stringifyModel orderId)) GHC.Base.++ ""))) [])
...
data DeleteOrderResponse
  = -- | Means either no matching case available or a parse error
    DeleteOrderResponseError GHC.Base.String
  | -- | Invalid ID supplied
