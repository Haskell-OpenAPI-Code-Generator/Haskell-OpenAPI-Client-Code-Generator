...
-- | > GET /pet/findByStatus
-- 
-- The same as 'findPetsByStatus' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
...
findPetsByStatusWithConfigurationRaw config
                                     status = GHC.Base.id (OpenAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack "/pet/findByStatus") [OpenAPI.Common.QueryParameter (Data.Text.pack "status") (GHC.Maybe.Just GHC.Base.$ Data.Aeson.Types.ToJSON.toJSON status) (Data.Text.pack "form") GHC.Types.True])
