...
-- | Contains the types generated from the schema Lizard
...
import {-# SOURCE #-} OpenAPI.Types.Gecko
import {-# SOURCE #-} OpenAPI.Types.GilaMonster

-- | Defines the oneOf schema located at @components.schemas.Lizard.oneOf@ in the specification.
-- 
-- 
data LizardVariants =
   LizardGecko Gecko
