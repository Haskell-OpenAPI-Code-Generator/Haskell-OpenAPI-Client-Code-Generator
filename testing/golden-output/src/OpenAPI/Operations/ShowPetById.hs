...
showPetById petId = GHC.Internal.Base.fmap (\response_0 -> GHC.Internal.Base.fmap (GHC.Internal.Data.Either.either ShowPetByIdResponseError GHC.Internal.Base.id GHC.Internal.Base.. (\response body -> if | GHC.Internal.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> ShowPetByIdResponseDefault GHC.Internal.Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: GHC.Internal.Data.Either.Either GHC.Internal.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                    Dog)
...
data ShowPetByIdResponse =
   ShowPetByIdResponseError GHC.Internal.Base.String -- ^ Means either no matching case available or a parse error
...
showPetByIdWithConfiguration config
                             petId = GHC.Internal.Base.fmap (\response_1 -> GHC.Internal.Base.fmap (GHC.Internal.Data.Either.either ShowPetByIdResponseError GHC.Internal.Base.id GHC.Internal.Base.. (\response body -> if | GHC.Internal.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> ShowPetByIdResponseDefault GHC.Internal.Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: GHC.Internal.Data.Either.Either GHC.Internal.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                     Dog)
...
showPetByIdRaw petId = GHC.Internal.Base.id (OpenAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Internal.Base.$ Data.Text.Internal.pack "GET") ("/pets/" GHC.Internal.Base.<> (OpenAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Internal.Base.$ (OpenAPI.Common.textToByte GHC.Internal.Base.$ OpenAPI.Common.stringifyModel petId)) GHC.Internal.Base.<> "")) GHC.Internal.Base.mempty)
-- | > GET /pets/{petId}
-- 
...
showPetByIdWithConfigurationRaw config
                                petId = GHC.Internal.Base.id (OpenAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Internal.Base.$ Data.Text.Internal.pack "GET") ("/pets/" GHC.Internal.Base.<> (OpenAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Internal.Base.$ (OpenAPI.Common.textToByte GHC.Internal.Base.$ OpenAPI.Common.stringifyModel petId)) GHC.Internal.Base.<> "")) GHC.Internal.Base.mempty)
