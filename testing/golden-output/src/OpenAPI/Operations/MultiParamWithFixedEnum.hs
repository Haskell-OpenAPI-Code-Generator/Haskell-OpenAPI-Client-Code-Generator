...
multiParamWithFixedEnum parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either MultiParamWithFixedEnumResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> MultiParamWithFixedEnumResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                       ...
                                                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (OpenAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/pet/multiparamwithfixedenum" [OpenAPI.Common.QueryParameter (Data.Text.Internal.pack "fixedenumvalue") (GHC.Maybe.Just GHC.Base.$ Data.Aeson.Types.ToJSON.toJSON (multiParamWithFixedEnumParametersQueryFixedenumvalue parameters)) (Data.Text.Internal.pack "form") GHC.Types.False,
                                                                                                                                                                                                                                                                                                                                                                                                                               OpenAPI.Common.QueryParameter (Data.Text.Internal.pack "other") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> multiParamWithFixedEnumParametersQueryOther parameters) (Data.Text.Internal.pack "form") GHC.Types.False])
...
multiParamWithFixedEnumWithConfigurationRaw config
                                            parameters = GHC.Base.id (OpenAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/pet/multiparamwithfixedenum" [OpenAPI.Common.QueryParameter (Data.Text.Internal.pack "fixedenumvalue") (GHC.Maybe.Just GHC.Base.$ Data.Aeson.Types.ToJSON.toJSON (multiParamWithFixedEnumParametersQueryFixedenumvalue parameters)) (Data.Text.Internal.pack "form") GHC.Types.False,
                                                                                                                                                                                                                 OpenAPI.Common.QueryParameter (Data.Text.Internal.pack "other") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> multiParamWithFixedEnumParametersQueryOther parameters) (Data.Text.Internal.pack "form") GHC.Types.False])
