...
singleParam status = GHC.Internal.Base.fmap (\response_0 -> GHC.Internal.Base.fmap (GHC.Internal.Data.Either.either SingleParamResponseError GHC.Internal.Base.id GHC.Internal.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> SingleParamResponse200 GHC.Internal.Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: GHC.Internal.Data.Either.Either GHC.Internal.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Dog)
...
instance Data.Aeson.Types.FromJSON.FromJSON SingleParamParametersStatus
    where {parseJSON val = GHC.Internal.Base.pure (if | val GHC.Classes.== "available" -> SingleParamParametersStatusEnumAvailable
                                                      | val GHC.Classes.== "pending" -> SingleParamParametersStatusEnumPending
                                                      | val GHC.Classes.== "sold" -> SingleParamParametersStatusEnumSold
                                                      | GHC.Internal.Base.otherwise -> SingleParamParametersStatusOther val)}
...
data SingleParamResponse =
   SingleParamResponseError GHC.Internal.Base.String -- ^ Means either no matching case available or a parse error
...
singleParamWithConfiguration config
                             status = GHC.Internal.Base.fmap (\response_2 -> GHC.Internal.Base.fmap (GHC.Internal.Data.Either.either SingleParamResponseError GHC.Internal.Base.id GHC.Internal.Base.. (\response body -> if | (\status_3 -> Network.HTTP.Types.Status.statusCode status_3 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> SingleParamResponse200 GHC.Internal.Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: GHC.Internal.Data.Either.Either GHC.Internal.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           Dog)
...
-- | > GET /pet/singleparam
-- 
-- The same as 'singleParam' but returns the raw 'Data.ByteString.ByteString'.
...
-- | > GET /pet/singleparam
-- 
-- The same as 'singleParam' but accepts an explicit configuration and returns the raw 'Data.ByteString.ByteString'.
